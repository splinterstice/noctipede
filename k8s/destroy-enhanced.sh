...
# Enhanced Noctipede Kubernetes Destruction Script
# This script safely removes all enhanced Noctipede components

set -e

echo "🗑️  Starting Enhanced Noctipede Destruction..."
echo "=============================================="
...
# Confirmation prompt
echo ""
print_warning "This will permanently delete ALL enhanced Noctipede resources including:"
echo "  • Enhanced portal with proxy status API"
echo "  • Smart crawler with readiness checking"
...
echo ""
print_info "Starting enhanced destruction process..."

# Step 1: Delete enhanced components first
echo ""
echo "🔄 Stopping enhanced components..."
kubectl delete deployment noctipede-smart-crawler -n noctipede --ignore-not-found=true --timeout=60s
kubectl delete cronjob noctipede-smart-crawler-cron -n noctipede --ignore-not-found=true --timeout=60s
print_status "Enhanced crawler components stopped"

# Step 2: Delete all jobs and cronjobs
echo ""
...
# Step 3: Delete all deployments and statefulsets
echo ""
...
# Step 5: Delete all pods (in case any are stuck)
echo ""
...
echo ""
echo "🎉 ENHANCED DESTRUCTION COMPLETED!"
echo "=================================="
echo ""
print_status "Enhanced Noctipede has been completely removed from the cluster"
echo ""
...
echo "• Redeploy enhanced: ./deploy-enhanced.sh"
echo ""
print_info "Enhanced destruction script completed successfully!"
